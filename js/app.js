...
const LD_SLIDES=[
 ...
 {act:'suteuk', ic:'book', mc:'#ff9db1', tt:'9모대비 수특퀴즈', wide:true,
  ds:'수능특강 세계지리 1~4강과 「이것이 수특 정리다」 특강 자료 01~25에 나온 내용만 물어봐요. 단답·순서 배열·지도 클릭·기후 그래프로 묻고, 틀린 문항은 오답노트로 정리해 PDF로 저장할 수 있어요.',
  pts:'2 · 3 · 4점', diff:'sqdiff', levels:['L','M','H'],
  dd:{L:'하 · 60문항 (객관식 위주)',M:'중 · 100문항',H:'상 · 전 문항 · 보기 없이 직접 쓰는 주관식 위주'}}
];
const TRADE_DD={
