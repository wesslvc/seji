/* ══════════════════════════════════════════════════════════════════════════
   ...
   본편의 몫이라 건드리지 않고(어비스에는 점수도 랭킹도 없다), 진행 기록은
   본편이 한 번 데어 본 자리라 아예 올리지 않는다(js/store.js 의 주석 참고).

   오답은 본편 것과 **다른 범주**다. 문항 자체가 다르고 채점 방식도 다르므로
   한 그릇에 담으면 둘 다 못 쓴다. 그래서 본편이 쓰지 않는 키(abyss_wrong,
   abyss_fav)에 따로 담고, 어느 쪽도 상대의 것을 읽지 않는다.
...
function mountOverlays(){
  ...
  const login=el('<div class="ab-ov" id="ab-login"><div class="ab-card">'
    ...
    +'<p class="sub">지오글 본편과 같은 계정입니다. 로그인하면 틀린 문항과 '
      +'즐겨찾기가 계정에 남아 다른 기기에서도 이어집니다.<br>'
      +'<b>어비스의 오답은 본편의 오답과 따로 쌓입니다</b> — 여기 문항은 본편에 없고, '
      +'본편 문항도 여기에 오지 않습니다.</p>'
