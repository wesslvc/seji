...
PARTS = [
    ...
    ('land',   '지형',           '대지형과 판 구조, 화산, 외적영력이 깎아 낸 소지형과 해안 지형', [28, 29, 30, 31]),
    ('religion','종교',          '크리스트교·이슬람교·불교·힌두교와 민족 종교 — 종파·성지·건축·금기', [34, 35, 36, 37, 38]),
    ('people', '인구',           '대륙별 인구와 인구 순위, 인구 지표·문제·이동, 난민', [39, 40, 41, 42, 43, 44, 45, 46]),
    ('city',   '도시',           '수도와 다른 수위도시, 종주도시화가 없는 나라', [47, 48]),
]
...
HEAD = {
 ...
 (31,'기타(빙하호)'):(2,'기타 — 빙하호'),
 (31,'주빙하지형'):(1,'주빙하 지형'),
 (31,'해안지형'):(1,'해안 지형'), (31,'침수해안'):(2,'침수 해안'),
 (31,'곶(암석해안)'):(2,'곶 — 암석 해안'), (31,'갯벌(만)'):(2,'갯벌 — 만'),
 (31,'모래해안(만)'):(2,'모래 해안 — 만'), (31,'해안지형복원'):(2,'해안 지형 복원'),
 (31,'산호해안'):(2,'산호 해안'), (31,'맹그로브숲'):(2,'맹그로브숲'),
 (40,'10억+'):(1,'10억 명 이상'), (40,'3억+'):(1,'3억 명 이상'), (40,'2억+'):(1,'2억 명 이상'),
 (40,'1억+'):(1,'1억 명 이상'), (40,'8000만'):(1,'8천만 명 이상'), (40,'7000만'):(1,'7천만 명 이상'),
 (40,'6000만+'):(1,'6천만 명 이상'), (40,'5160만+'):(1,'대한민국(5,160만)까지'),
 (41,'유소년 관련 지표'):(1,'유소년층 관련 지표'), (41,'청장년층 관련 지표'):(1,'청장년층 관련 지표'),
 (41,'노년층 관련 지표'):(1,'노년층 관련 지표'),
 (43,'선진국'):(1,'선진국'), (43,'개도국'):(1,'개발도상국'),
 (44,'기간'):(1,'기간'), (44,'동기'):(1,'동기'), (44,'원인'):(1,'원인'),
 (45,'아프리카'):(1,'아프리카'), (45,'아시아'):(1,'아시아'),
 (45,'라틴아메리카- 앵글로아메리카로'):(1,'라틴아메리카','앵글로아메리카로 가장 많이 이동'),
 (45,'앵글로아메리카'):(1,'앵글로아메리카'), (45,'유럽'):(1,'유럽'), (45,'오세아니아'):(1,'오세아니아'),
 (47,'아시아 (9개국)'):(1,'아시아 — 9개국'), (47,'유럽 (3개국)'):(1,'유럽 — 3개국'),
 (47,'앵글로아메리카 (2개국)'):(1,'앵글로아메리카 — 2개국'), (47,'라틴아메리카 (4개국)'):(1,'라틴아메리카 — 4개국'),
 (47,'아프리카 (11개국)'):(1,'아프리카 — 11개국'), (47,'오세아니아 (4개국)'):(1,'오세아니아 — 4개국'),
 (48,'아시아 8개국'):(1,'아시아'), (48,'유럽'):(1,'유럽'),
 (48,'이 밑에는 2배에 아주 살짝 못미치는 정도(애매) -------'):(2,'2배에 살짝 못 미치는 나라(애매)'),
 (48,'아프리카'):(1,'아프리카'), (48,'앵글로아메리카'):(1,'앵글로아메리카'),
 (48,'남아메리카'):(1,'남아메리카'), (48,'오세아니아'):(1,'오세아니아'),
}
...
FIG_AT = {
 ...
 'img/codex/image19.webp': '해안 지형',   # 해안 지형 블록 그림
 'img/codex/image20.webp': 'BW · 사막',   # 사막 지도(원인별 색) — image16 보다 앞에
}
...
def feed(box, rows, sec_n, stack):
    ...
    for kind, t, extra in rows:
        ...
        if h:
            ...
            stack[-1].add('group', g)
            stack.append(g)
            if len(h) > 2:          # 제목 줄에 붙어 있던 내용('라틴아메리카- 앵글로아메리카로')
                g.add('li', h[2])
            continue
